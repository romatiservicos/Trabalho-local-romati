                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-3 form-inline">
                            <label for="idTab_TipoTratamentos">Tipo de Sessão:</label><br>
                            <div class="form-group">
                                <div class="btn-group" data-toggle="buttons">
                                    <?php
                                    foreach ($select['TipoTratamentos'] as $key => $row) {
                                        (!$query['idTab_TipoTratamentos']) ? $query['idTab_TipoTratamentos'] = '1' : FALSE;

                                        if ($query['idTab_TipoTratamentos'] == $key) {
                                            echo ''
                                            . '<label class="btn btn-warning active" name="radio_idTab_TipoTratamentos" id="radiogeral' . $key . '">'
                                            . '<input type="radio" name="idTab_TipoTratamentos" id="radiogeral" '
                                                . 'autocomplete="off" value="' . $key . '" checked>' . $row
                                            . '</label>'
                                            ;
                                        } else {
                                            echo ''
                                            . '<label class="btn btn-default" name="radio_idTab_TipoTratamentos" id="radiogeral' . $key . '">'
                                            . '<input type="radio" name="idTab_TipoTratamentos" id="radiogeral" '
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <a class="btn btn-xs btn-info" href="<?php echo base_url() ?>tabelas/profissional/profissional" role="button"> 
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <a class="btn btn-xs btn-info" href="<?php echo base_url() ?>tabelas/servico/servico" role="button"> 
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <a class="btn btn-xs btn-info" href="<?php echo base_url() ?>tabelas/produto/produto" role="button"> 
