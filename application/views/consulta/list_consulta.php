        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div>
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#anterior" aria-controls="anterior" role="tab" data-toggle="tab">Histórico de Sessão</a></li>
					<li role="presentation" ><a href="#proxima" aria-controls="proxima" role="tab" data-toggle="tab">Próximas Sessão</a></li>
